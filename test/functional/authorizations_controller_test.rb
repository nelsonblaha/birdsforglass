...
class AuthorizationsControllerTest < ActionController::TestCase
  ...
  test "should create authorization" do
    assert_difference('Authorization.count') do
      post :create, authorization: { access_token: @authorization.access_token, oauth_token_secret: @authorization.oauth_token_secret, provider: @authorization.provider, refresh_token: @authorization.refresh_token, uid: @authorization.uid, user_id: @authorization.user_id }
    end
  ...
  test "should update authorization" do
    put :update, id: @authorization, authorization: { access_token: @authorization.access_token, oauth_token_secret: @authorization.oauth_token_secret, provider: @authorization.provider, refresh_token: @authorization.refresh_token, uid: @authorization.uid, user_id: @authorization.user_id }
    assert_redirected_to authorization_path(assigns(:authorization))
  end
